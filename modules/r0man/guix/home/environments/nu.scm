(define-module (r0man guix home environments nu)
  ...
  #:use-module (r0man guix home services container-home)
  ...
  #:use-module (r0man guix home services stumpwm)
  #:use-module (r0man guix home services sway)
  #:use-module (r0man guix home tmux)
  #:use-module (r0man guix home services waybar)
  #:use-module (r0man guix home services wofi)
  #:use-module (r0man guix home services x11)
          ...
          (list (service home-bash-service-type
                ...
                (service home-git-service-type
                         (home-git-configuration
                          ...
                          (sendemail-from "Roman Scherer <roman.scherer@nubank.com.br>")
                          (sendemail-smtp-user "roman.scherer@nubank.com.br")
                          (signing-key "EE1FCAB5603B8536")
                          (user-email "roman.scherer@nubank.com.br")
                          (user-name "Roman Scherer")))
                ...
                (service home-startx-command-service-type
                         (xorg-configuration
                          ...
                          ;; https://download.nvidia.com/XFree86/Linux-x86_64/580.159.03
