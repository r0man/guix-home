...
#+begin_src emacs-lisp
  (use-package ellama
    ...
    (add-to-list 'ellama-providers
                 (cons "Claude Sonnet"
                       (make-llm-claude
                        :key (auth-source-pick-first-password :host "api.anthropic.com" :user "personal")
    ...
    (setq ellama-provider (alist-get "Claude Opus" ellama-providers nil nil #'string=)))
...
#+begin_src emacs-lisp
  (use-package gptel
    ...
    (gptel-make-anthropic "Claude"
      :stream t
      :key (lambda ()
             (auth-source-pick-first-password :host "api.anthropic.com" :user "personal")))
