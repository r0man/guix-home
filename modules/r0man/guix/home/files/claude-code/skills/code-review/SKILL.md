---
name: code-review
description: Comprehensive multi-lens code review — examines a PR, branch, or set of files through several specialized review lenses (correctness, performance, security, elegance, resilience, style, smells, wiring, commit discipline, test quality) and synthesizes a single prioritized, actionable review. Use this skill whenever the user asks to review a PR/branch/diff/files, wants a "thorough" or "proper" or "deep" code review, asks "is this ready to merge", wants a pre-merge gate check, or wants a security review of changes. Prefer this over a single-pass read-through whenever the change is more than trivial — a one-lens skim misses the classes of problem the other lenses catch. This is the multi-lens-convoy-with-presets review; for a quick reuse/quality cleanup of code you just wrote, the simplify skill is lighter.
---
