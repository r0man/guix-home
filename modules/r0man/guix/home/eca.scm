...
(define-record-type* <home-eca-configuration>
  ...
  (authinfo-script home-eca-authinfo-script
                   (default (local-file "files/eca/eca-server-authinfo"))
                   (description "Path to eca-server-authinfo script.")))
...
(define (home-eca-files config)
  ...
  `((".config/eca/AGENTS.md" ,(home-eca-agents-file config))
    ...
    (".local/bin/eca-server-authinfo" ,(home-eca-authinfo-script config))))
